<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("solicitar");
					i++;


		var j=0;
						if(notEmpty(myInputs[j]) && !isAlphanumeric(myInputs[j])) {
							alert("Please enter valid solicitar");
							myInputs[j].focus();
							return false;
						}
...
<div id="container">
	<div id="header">
		User Task Form: Solicitud.Solicitar
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		<label for="name">solicitar</label>
                            		<div class="div_checkbox">
                              		${solicitar}
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="solicitar" type="text" class="textbox" id="solicitar" value="${solicitar}" />
                            		</div>
