<script type='text/javascript'>
	...
	function taskFormValidator() {
		...
		var myInputs = new Array();
					myInputs[i] = document.getElementById("student");
					i++;
...
<div id="container">
	<div id="header">
		User Task Form: Admission Process.ReviewGPA
	</div>
	<div id="content">
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="student" type="text" class="textbox" id="student" value="${student}" />
                            		</div>
